...
// @version      0.4.5
// @description  PS UserScript (battle for you)
// @author       Kirby90
...
console.log("%c TAMPERMONKEY HERE","font-size:50px;")
...
/*
Generate a panel starting the whole thing
*/

var panel = document.createElement("div")
panel.style.padding = "10px"
panel.style.position = "absolute"
panel.style.backgroundColor = "#b4b4b4"
panel.style.border = "solid #5f5f5f 2px"
...
startBtn.style.fontFamily = "Courier New"
startBtn.style.border = "solid transparent 0px"
startBtn.style.borderRadius = "10px"
startBtn.style.backgroundColor = "#787878"
startBtn.style.position = "relative"
...
async function startLoop() {
    ...
    warningTxt.innerHTML = "! Warning !<br>After pressing this button the script will start and you'll have to resfresh the page to start it again or stop it!<br>Are you sure to start it now ?"
    warningTxt.style.color = "red"
    warningTxt.style.margin = "20px"
    warningTxt.position = "inherit"
    warningTxt.style.marginBottom = "30px"

    var yesBtn = document.createElement("button")
    yesBtn.innerHTML = "YES"
    yesBtn.style.fontFamily = "Courier New"
    yesBtn.style.border = "solid transparent 0px"
    yesBtn.style.borderRadius = "10px"
    yesBtn.style.backgroundColor = "#787878"
    yesBtn.style.position = "absolute"
    yesBtn.style.bottom = "5px"
    yesBtn.style.left = "5px"
    yesBtn.style.fontSize = "20px"
    yesBtn.style.cursor = "pointer"

    var noBtn = document.createElement("button")
    noBtn.innerHTML = "NO"
    noBtn.style.fontFamily = "Courier New"
    noBtn.style.border = "solid transparent 0px"
    noBtn.style.borderRadius = "10px"
    noBtn.style.backgroundColor = "#787878"
    noBtn.style.position = "absolute"
    noBtn.style.bottom = "5px"
    noBtn.style.right = "5px"
    noBtn.style.fontSize = "20px"
    noBtn.style.cursor = "pointer"

    var killfunction = function() {
        popup.remove()
    }
